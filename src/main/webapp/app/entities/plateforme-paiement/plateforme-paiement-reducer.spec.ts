...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './plateforme-paiement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PLATEFORMEPAIEMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_PLATEFORMEPAIEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PLATEFORMEPAIEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PLATEFORMEPAIEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PLATEFORMEPAIEMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PLATEFORMEPAIEMENT actions', async () => {
      const expectedActions = [
        {
